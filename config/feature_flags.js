...
module.exports = {
  ...
  ENABLE_NEW_FLOW_ARCH: envBool('ENABLE_NEW_FLOW_ARCH', false),
  ENABLE_NEW_FLOW_IMAGE_INGEST: envBool('ENABLE_NEW_FLOW_IMAGE_INGEST', false),
  ENABLE_NEW_FLOW_IMAGE_FOLLOWUP: envBool('ENABLE_NEW_FLOW_IMAGE_FOLLOWUP', false),
  ENABLE_NEW_FLOW_GENERAL_FOLLOWUP: envBool('ENABLE_NEW_FLOW_GENERAL_FOLLOWUP', false),
  ENABLE_NEW_FLOW_RESPONSE_GUARD: envBool('ENABLE_NEW_FLOW_RESPONSE_GUARD', true),
};
